...
public class SourceClassifierSingleNetwork1 extends SourceClassifier1 {

    private Network1 network = new Network1("sourceClassifier", new int [] {KeywordCounter.getNoOfKeywords(), 40, 20, 3});
    ...
    double [] composeTargets(Network1 network, boolean isJava, boolean isPython, boolean isC) {
